...
'@
  ...
  Invoke-BmfConsoleCommand 'bmf.status' 'bmf-status' @('BMF bmf.status OK', 'version=0.1.0-ea3.cl15526')
  Invoke-BmfConsoleCommand 'bmf.health' 'bmf-health' @('BMF bmf.health OK', 'target_build=PC-Shipping-CL15526', 'plugins_loaded=')
  Invoke-BmfConsoleCommand 'bmf.version' 'bmf-version' @('BMF bmf.version OK', 'version=0.1.0-ea3.cl15526', 'target_build=PC-Shipping-CL15526')
